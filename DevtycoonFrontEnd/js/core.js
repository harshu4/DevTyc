...
Core.init = function(fromLoad){
	...
	if(!fromLoad){
		...
		Marquee.show('Welcome to devtycoon. You can now become the richest rich in the world.')
	}else{
	...
	document.title = Stats.companyName + ' intranet | devtycoon'
...
Core.showImprovementButton = function(id){
	...
	var button = document.createElement('button')
		...
		button.innerText = button.textContent = improvements[id].label 
...
Core.addToShowcase = function(text){
	$("#showcase").text(text)
}
