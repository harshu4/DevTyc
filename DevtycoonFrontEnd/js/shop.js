...
Shop.items = {
	'coffee': {
		...
		'initial': true,
		'label': 'Buy coffee',
		'help': '1 Coffee provides you 1 block working efficiency.',
	...
	'energyDrink': {
		...
		'help': '1 Energy drink bar provides you 3 block working efficiency',
		'buy': function(button, secondsLeft){
	...
	'choclateBar': {
		...
		'oneuse': false,
		'initial': true,
		'label': 'Buy choclate bar',
		'help': '1 Choclate bar provides you 3 block working efficiency.',
		'buy': function(button, secondsLeft){
...
Shop.showItemButton = function(itemID){
	...
	button.innerText = button.textContent = button.textContent = item.label
